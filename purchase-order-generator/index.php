...
// Opt-in only: the purchase order is built in the browser and never reaches the
// server, so there is no document to mail and nothing to attach.
tool_email_capture([
    'source' => 'purchase_order_generator',
    'mode'   => 'optin',
    'title'  => 'Get occasional Argo Books updates',
    'blurb'  => 'Your purchase order stays in your browser and is never sent to us. This is just the mailing list: new features, and tips for keeping books without an accountant.',
    'cta'    => 'Sign me up',
]);
